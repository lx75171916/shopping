...
<body>
	<div class="mianCont">
		...
		<div class="lsg">
			...
			<div class="gouwuche">
				<div class="gouCar">
					<img src="images/gouimg.png" width="19" height="20"
						style="position: relative; top: 6px;" />&nbsp;|&nbsp; <strong
						class="red">0</strong>&nbsp;件&nbsp;| <strong class="red">￥
						0.00</strong> <a href="order.html">去结算</a> <img src="images/youjian.jpg"
						width="5" height="8" />
				</div>
				<!--gouCar/-->
				<div class="myChunlv">
					<a href="vip.html"><img src="images/mychunlv.jpg" width="112"
						height="34" /></a>
				</div>
				<!--myChunlv/-->
			</div>
		...
		<div class="cont">
			<div class="contLeft" id="contLeft">
				...
				<dl class="helpNav vipNav">
					<dt>我的主页</dt>
					<dd>
						<a href="vip.html">个人中心</a> <a href="vipOrder.html" class="vipCur">我的订单</a>
					</dd>
					<dt>账户设置</dt>
					<dd>
						<a href="vipMy.html">个人信息</a> <a href="vipPwd.html">密码修改</a> <a
							href="vipAdress.html">收货地址</a>
					</dd>
					<dt>客户服务</dt>
					<dd>
						<a href="vipExit.html">网站使用条款</a> <a href="vipTuihuo.html">网站免责声明</a>
			...
			<div class="contRight">
				...
				<h2 class="oredrName">我的订单</h2>
				<table class="vipOrder">
					<c:forEach items="${orders }" var="order">
						<tr>
							<td><a href="#"><img src="${order.goods.icon }" width="60"
									height="55"></a></td>
							<td>${order.goods.goodsname }</td>
							<td>数量:${order.goodsnumber }</td>
							<td>￥${order.price }<br />支付宝支付
							</td>
							<td>${order.tbuytime }</td>
							<td><a href="#"><strong>删除订单</strong></a></td>
				...
				<br />
				<div class="scott">
					第<input id="pag" disabled="disabled" value="" style="width: 40px;" />页
					<button onclick="first()">首页</button>
					<button onclick="before()">上一页</button>
					<button onclick="after()">下一页</button>
					<button onclick="foot()">尾页</button>
					<input id="init" onchange="init(this)" type="number"
						style="width: 40px;" />
					<button onclick="go(this)">跳转</button>
				</div>
				<br />
			</div>
			<!--contRight/-->
		...
		<div class="footer">
			<p>
				<a href="#">进入17官网</a>&nbsp;|&nbsp; <a href="index.html">商城首页</a>&nbsp;|&nbsp;
				<a href="product.html">促销中心</a>&nbsp;|&nbsp; <a href="order.html">我的订单</a>&nbsp;|&nbsp;
				<a href="new.html">新闻动态</a>&nbsp;|&nbsp; <a href="login.html">会员中心</a>&nbsp;|&nbsp;
...
<script type="text/javascript">
		...
		$(function() {
			source = $(".vipOrder tr");
			pages = source.length;
			maxpage = pages % size == 0 ? parseInt(pages / size) : parseInt(pages / size) + 1;
		...
		function changepage(page) {
			...
			for(var i = 0; i < pages; i++) {
				if(i < start || i > end) {
					source.get(i).style.display = "none";
				} else {
					source.get(i).style.display = "";
				}
			}
			change();
		}
